  ...
  return (
    <React.Fragment>
      ...
      <Route
        ...
        path="/addpayment"
        render={props => {
          if (isAuthenticated()) return <AddPaymentTypes {...props} />;
      ...
      <Route
        exact
        path="/productlist/:productTypeId(\d+)"
        render={props => {
      ...
      <Route
        ...
        path="/products/sell"
        render={props => {
          if (isAuthenticated()) return <SellProductForm {...props} />;
          else return <Redirect to="/login" />;
        }}
      />
    </React.Fragment>
