...
const SellProductForm = props => {
  ...
  const addToProducts = e => {
    ...
    if (price.current.value < 0.01 || price.current.value > 10000) {
      window.alert(
        "Product price must be greater than $0 and cannot exceed $10,000"
      );
    } else {
    ...
    <React.Fragment>
      <form>
        ...
        <div>
          ...
          <select type="product_type" name="product_type" ref={product_type}>
